...
test("Hamro_pay", async ({ page }) => {
  ...
  if (currentURL === expectedURL) {
    ...
    expect(
      ...
      "URL should match expected hamro pay"
    ).toBe(true);
  } else {
...
test("Hamro_mart", async ({ page }) => {
  ...
  if (currentURL === expectedURL) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected mart page"
    ).toBe(true);
  } else {
...
test("Hamro_jotish", async ({ page }) => {
  ...
  if (currentURL === expectedURL) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected hamro jotish"
    ).toBe(true);
  } else {
...
test("Notesandevent", async ({ page }) => {
  ...
  if (currentURL === "https://app.hamropatro.com/notes") {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected notes and event page"
    ).toBe(true);
  } else {
...
test("Patroview", async ({ page }) => {
  ...
  if (currentURL === "https://app.hamropatro.com/calendar?v=patro") {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected patro view"
    ).toBe(true);
  } else {
...
test("साइत", async ({ page }) => {
  ...
  if (currentURL === expectedURL) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected साइत page"
    ).toBe(true);
  } else {
...
test("मिति परिवर्तन", async ({ page }) => {
  ...
  if (currentURL === expectedURL) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected मिति परिवर्तन page"
    ).toBe(true);
  } else {
    console.log("❌ Test case failed: URL is incorrect for मिति परिवर्तन");
    expect(
      currentURL === expectedURL,
      "URL should match expectedमिति परिवर्तन page"
    ).toBe(false);
  }
});
test("बिदाहरू", async ({ page }) => {
  ...
  if (currentURL === expectedURL) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected बिदाहरू page"
    ).toBe(true);
  } else {
    console.log("❌ Test case failed: URL is incorrect for बिदाहरू");
    expect(
      currentURL === expectedURL,
      "URL should match expectedमिति बिदाहरू page"
    ).toBe(false);
  }
});
test("समाचार", async ({ page }) => {
  ...
  if (currentURL === expectedURL) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected समाचार page"
    ).toBe(true);
  } else {
    console.log("❌ Test case failed: URL is incorrect for समाचार");
    expect(
      currentURL === expectedURL,
      "URL should match expectedमिति समाचार page"
    ).toBe(false);
  }
});
test("रेडियो", async ({ page }) => {
  ...
  if (currentURL === expectedURL) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected रेडियो page"
    ).toBe(true);
  } else {
    console.log("❌ Test case failed: URL is incorrect for रेडियो");
    expect(
      currentURL === expectedURL,
      "URL should match expectedमिति रेडियो page"
    ).toBe(false);
  }
});
...
test("विनिमय दर", async ({ page }) => {
  ...
  if (currentURL === expectedURL) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected विनिमय दर page"
    ).toBe(true);
  } else {
    console.log("❌ Test case failed: URL is incorrect for  विनिमय दर");
    expect(
      currentURL === expectedURL,
      "URL should match expectedमिति विनिमय दर page"
    ).toBe(false);
  }
});
test("राशिफल", async ({ page }) => {
  ...
  if (currentURL === expectedURL) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected राशिफल page"
    ).toBe(true);
  } else {
    console.log("❌ Test case failed: URL is incorrect for राशिफल");
    expect(
      currentURL === expectedURL,
      "URL should match expectedमिति राशिफल page"
    ).toBe(false);
  }
});
...
test("हाम्रो ज्योतिष", async ({ page }) => {
  ...
  if (currentURL === expectedURL) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected हाम्रो ज्योतिष"
    ).toBe(true);
  } else {
    console.log("❌ Test case failed: URL is incorrect for हाम्रो ज्योतिष");
    expect(
      currentURL === expectedURL,
      "URL should match expectedमिति हाम्रो ज्योतिष"
    ).toBe(false);
  }
});
test("ब्लग", async ({ page }) => {
  ...
  if (currentURL === expectedURL) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected ब्लग page"
    ).toBe(true);
  } else {
    console.log("❌ Test case failed: URL is incorrect for ब्लग");
    expect(
      currentURL === expectedURL,
      "URL should match expectedमिति ब्लग page"
    ).toBe(false);
  }
});
...
test("अडियो / पोड्काष्ट", async ({ page }) => {
  ...
  if (currentURL === expectedURL) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected अडियो / पोड्काष्ट page"
    ).toBe(true);
  } else {
    console.log("❌ Test case failed: URL is incorrect for अडियो / पोड्काष्ट");
    expect(
      currentURL === expectedURL,
      "URL should match expected अडियो / पोड्काष्ट"
    ).toBe(false);
  }
});
...
test("सुन/चाँदी", async ({ page }) => {
  ...
  if (currentURL.includes(expectedURL)) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected सुन/चाँद page"
    ).toBe(true);
  } else {
...
test("ब्याज दर", async ({ page }) => {
  ...
  if (currentURL.includes(expectedURL)) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected ब्याज दर page"
    ).toBe(true);
  } else {
...
test("ई-लर्निंङ्", async ({ page }) => {
  ...
  if (currentURL.includes(expectedURL)) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected ई-लर्निंङ् page"
    ).toBe(true);
  } else {
    console.log("❌ Test case failed: URL is incorrect for ई-लर्निंङ्");
    expect(
      currentURL === expectedURL,
      "URL should match expected ई-लर्निंङ्page"
    ).toBe(false);
  }
});
test("क्विज", async ({ page }) => {
  ...
  if (currentURL.includes(expectedURL)) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected क्विज page"
    ).toBe(true);
  } else {
...
test("FOR_YOU", async ({ page }) => {
  ...
  if (currentURL.includes(expectedURL)) {
    ...
    expect(
      currentURL === expectedURL,
      "URL should match expected FOR_YOU page"
    ).toBe(true);
  } else {
    console.log("❌ Test case failed: URL is incorrect for FOR_YOU ");
    expect(
      currentURL === expectedURL,
      "URL should match expectedFOR_YOU page"
    ).toBe(false);
  }
});
